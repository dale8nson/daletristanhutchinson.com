...
const Jitsuin = ({position=[0,0,0], scale=[1,1,1]}) => {
  return (
    <div className='w-[1.88rem] h-[1.88rem] opacity-60 p-[0.0] border-japan-red border-solid border-[0.06125rem] bg-japan-red justify-center align-middle content-center rounded-sm ' >
